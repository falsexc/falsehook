-- made by dawid ~ edited/fixed by false --
...
function lib:new(text, preset, closebind)
    ...
    function lib:Notify(texttitle, textdesc, textbtn)
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Bind(text, keypreset, callback1, callback2)
            local binding = false
            ...
            Bind.MouseButton1Click:Connect(function()
                ...
                if inputwait.KeyCode.Name ~= "Unknown" then
                    ...
                    pcall(callback1, inputwait.KeyCode)
                    binding = false
                else
                    binding = false
                end
